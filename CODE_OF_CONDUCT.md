...
- **GitHub Issues:** [Create a private issue](https://github.com/luxarionadm-design/vexorion/issues/new) with the label `code-of-conduct` (issues are visible only to you and maintainers)
- **Alternative:** Contact any maintainer directly via GitHub
