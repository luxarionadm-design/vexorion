...
const logger = new LoggerModule({ prefix: 'MATRIX4' });
const warn = (...args) => logger.warn(...args);

const WebGLCoordinateSystem = 0;
const WebGPUCoordinateSystem = 1;
	...
	makePerspective(left, right, top, bottom, near, far, coordinateSystem = WebGLCoordinateSystem, reversedDepth = false) {
		...
		if (reversedDepth) {
			...
			if (coordinateSystem === WebGLCoordinateSystem) {
				...
				throw new Error('Matrix4.makePerspective(): Invalid coordinate system');
			}
		}
	...
	makeOrthographic(left, right, top, bottom, near, far, coordinateSystem = WebGLCoordinateSystem, reversedDepth = false) {
		...
		if (reversedDepth) {
			...
			if (coordinateSystem === WebGLCoordinateSystem) {
				...
				throw new Error('Matrix4.makeOrthographic(): Invalid coordinate system');
			}
		}
